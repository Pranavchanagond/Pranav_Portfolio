...
function Contact() {
  return (
    <div name='contact' className='p-4 pt-[80px] bg-black w-full h-screen flex justify-center items-center'>
      ...
      <form method='post' action="https://getform.io/f/6c19bd59-9fba-430b-a39e-bcb60ad1b7a7" className='flex flex-col w-full max-w-[600px]'>
        ...
        <input className=' p-2 bg-gray-700 ' type="text" placeholder='Name' name='name'  required/>
        <input className='p-2 my-4 bg-gray-700' type="email" placeholder='Email' name='email' required/>
